                            ...
                            <div class="card-body">
                                ...
                                <div class="item-quantity">
                                    ...
                                    <div class="input-group quantity-counter-wrapper">
                                        <input type="text" class="quantity-counter"  v-model="item.qty" @input="updateQuantity(item)" :ref="'qty-input-' + item.id" />
                                    </div>
                                </div>
                                ...
                                <div class="price-details">
                                    ...
                                    <ul class="list-unstyled">
                                        ...
                                        <li class="price-detail">
                                            ...
                                            <a href="javascript:void(0)" class="detail-amt text-primary">11%</a>
                                        </li>
                                        <li class="price-detail">
...
export default {
    ...
    methods: {
        ...
        updateQuantity(item) {
            axios.put(`/operator/cart/update/${item.id}`, { qty: item.qty }).then(() => {
                this.fetchCartItems();
            });
        },

        removeFromCart(itemId) {
            axios.delete(`/operator/cart/delete/${itemId}`).then(() => {
                this.fetchCartItems();
            });
        },
