                ...
                <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                    ...
                    <li class="scrollable-container media-list">
                        <div class="media align-items-center">
                            <img class="d-block rounded mr-1" src="{{ asset('theme/app-assets/images/pages/eCommerce/1.png') }}" alt="donuts" width="62">
                        ...
                        <div class="media align-items-center">
                            <img class="d-block rounded mr-1" src="{{ asset('theme/app-assets/images/pages/eCommerce/7.png') }}" alt="donuts" width="62">
                            <div class="media-body">
                                <i class="ficon cart-item-remove" data-feather="x"></i>
                                <div class="media-heading">
                        ...
                        <div class="media align-items-center">
                            <img class="d-block rounded mr-1" src="{{ asset('theme/app-assets/images/pages/eCommerce/2.png') }}" alt="donuts" width="62">
                            <div class="media-body">
                                <i class="ficon cart-item-remove" data-feather="x"></i>
                                <div class="media-heading">
                        ...
                        <div class="media align-items-center">
                            <img class="d-block rounded mr-1" src="{{ asset('theme/app-assets/images/pages/eCommerce/3.png') }}" alt="donuts" width="62">
                            <div class="media-body">
                                <i class="ficon cart-item-remove" data-feather="x"></i>
                                <div class="media-heading">
                        ...
                        <div class="media align-items-center">
                            <img class="d-block rounded mr-1" src="{{ asset('theme/app-assets/images/pages/eCommerce/5.png') }}" alt="donuts" width="62">
                            <div class="media-body">
                                <i class="ficon cart-item-remove" data-feather="x"></i>
                                <div class="media-heading">
