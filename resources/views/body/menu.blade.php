    ...
    <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">
            <li class="nav-item mr-auto"><a class="navbar-brand" href="../../../html/ltr/vertical-menu-template/index.html"><span class="brand-logo">
                    ...
                    <h2 class="brand-text">Go-Ticket</h2>
                </a></li>
        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class="nav-item
                @if(Route::is('super.admin.dashboard') ||
                    ...
                    Route::is('tenant.dashboard') ||
                    Route::is('supervisor.dashboard') ||
                    Route::is('operator.dashboard') ||
                    Route::is('visitor.dashboard')
                )
                    active
                @endif
                ">
            ...
            @elseif (Auth::check() && Auth::user()->role === 'playground_owner')
                <li class=" navigation-header">
                    <span data-i18n="Manager &amp; Settings">Manager &amp; Settings</span>
                ...
                <li class="nav-item @if(Route::is('tenant.dashboard.location')) active @endif">
                    <a class="d-flex align-items-center" href="{{ route('tenant.dashboard.location') }}">
                        ...
                        <span class="menu-title text-truncate" data-i18n="Map-Pin">Location</span>
                    </a>
                </li>
                <li class="nav-item @if(Route::is('tenant.dashboard.employee') || Route::is('tenant.dashboard.employee.detail')) active @endif">
                    <a class="d-flex align-items-center" href="{{ route('tenant.dashboard.employee') }}">
                        <i data-feather='users'></i>
                        <span class="menu-title text-truncate" data-i18n="Users">Employee</span>
                    </a>
                </li>
                <li class="nav-item @if(Route::is('tenant.dashboard.packet') || Route::is('tenant.dashboard.packet.add') || Route::is('tenant.dashboard.packet.edit')) active @endif">
                    <a class="d-flex align-items-center" href="{{ route('tenant.dashboard.packet') }}">
                ...
                <li class=" nav-item">
                    <a class="d-flex align-items-center" href="app-chat.html">
                        ...
                        <span class="menu-title text-truncate" data-i18n="Archive">Invoice</span>
                    </a>
                </li>
                <li class=" nav-item">
                    <a class="d-flex align-items-center" href="app-chat.html">
                        <i data-feather='book'></i>
                        <span class="menu-title text-truncate" data-i18n="Book">Ticket List</span>
                    </a>
                </li>
                <li class=" nav-item">
                    <a class="d-flex align-items-center" href="#">
                        <i data-feather='gift'></i>
                        <span class="menu-title text-truncate" data-i18n="Gift">Voucher Code</span></span>
                    </a>
                    <ul class="menu-content">
                        <li>
                            <a class="d-flex align-items-center" href="{{ route('tenant.dashboard.voucher') }}"><i data-feather="circle"></i>
                                <span class="menu-item text-truncate" data-i18n="Alerts">Voucher List</span>
                            </a>
                        </li>
                        <li>
                            <a class="d-flex align-items-center" href="#">
                                <i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Avatar">Voucher Redemption</span>
                            </a>
                        </li>
                    </ul>
                </li>
            ...
            @elseif (Auth::check() && Auth::user()->role === 'playground_operator')
                <li class="nav-item @if(Route::is('operator.transaction')) active @endif">
                    <a class="d-flex align-items-center" href="{{ route('operator.transaction') }}">
                        <i data-feather='shopping-cart'></i>
                        <span class="menu-title text-truncate" data-i18n="Users">Transaction</span>
                    </a>
                </li>
                <li class=" navigation-header">
                ...
                <li class="nav-item @if(Route::is('tenant.dashboard.employee') || Route::is('tenant.dashboard.employee.detail')) active @endif">
                    <a class="d-flex align-items-center" href="{{ route('tenant.dashboard.employee') }}">
                        <i data-feather='archive'></i>
                        <span class="menu-title text-truncate" data-i18n="Users">Invoice</span>
                    </a>
                </li>
                <li class="nav-item @if(Route::is('tenant.dashboard.employee') || Route::is('tenant.dashboard.employee.detail')) active @endif">
                    <a class="d-flex align-items-center" href="{{ route('tenant.dashboard.employee') }}">
                        <i data-feather='book'></i>
                        <span class="menu-title text-truncate" data-i18n="Users">Ticket List</span>
                    </a>
                </li>
            @elseif (Auth::check() && Auth::user()->role === 'visitor_member')
