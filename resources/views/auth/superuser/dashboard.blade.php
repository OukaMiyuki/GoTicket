                    ...
                    <div class="row match-height">
                        ...
                        <div class="col-xl-4 col-md-6 col-12">
                            <div class="card card-congratulation-medal">
                                <div class="card-body">
                                    <h5>Revenue Tiket!</h5>
                                    <p class="card-text font-small-3">Total pendapatan penjualan tiket.</p>
                                    <h3 class="mb-75 mt-2 pt-50">
                                        <a href="javascript:void(0);">$48.9k</a>
                                    </h3>
                                    <button type="button" class="btn btn-primary">View Sales</button>
                                    <img src="{{ asset('theme/app-assets/images/illustration/badge.svg') }}" class="congratulation-medal" alt="Medal Pic" />
                                </div>
                            </div>
                        </div>
                        <!--/ Medal Card -->
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar rounded">
                                                                <div class="avatar-content">
                                                                    <img src="{{ asset('theme/app-assets/images/icons/toolbox.svg') }}" alt="Toolbar svg" />
                                                                </div>
                                                            </div>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar rounded">
                                                                <div class="avatar-content">
                                                                    <img src="{{ asset('theme/app-assets/images/icons/parachute.svg') }}" alt="Parachute svg" />
                                                                </div>
                                                            </div>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar rounded">
                                                                <div class="avatar-content">
                                                                    <img src="{{ asset('theme/app-assets/images/icons/brush.svg') }}" alt="Brush svg" />
                                                                </div>
                                                            </div>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar rounded">
                                                                <div class="avatar-content">
                                                                    <img src="{{ asset('theme/app-assets/images/icons/star.svg') }}" alt="Star svg" />
                                                                </div>
                                                            </div>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar rounded">
                                                                <div class="avatar-content">
                                                                    <img src="{{ asset('theme/app-assets/images/icons/book.svg') }}" alt="Book svg" />
                                                                </div>
                                                            </div>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar rounded">
                                                                <div class="avatar-content">
                                                                    <img src="{{ asset('theme/app-assets/images/icons/rocket.svg') }}" alt="Rocket svg" />
                                                                </div>
                                                            </div>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar rounded">
                                                                <div class="avatar-content">
                                                                    <img src="{{ asset('theme/app-assets/images/icons/speaker.svg') }}" alt="Speaker svg" />
                                                                </div>
                                                            </div>
                                                            <div>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="card card-developer-meetup">
                                <div class="meetup-img-wrapper rounded-top text-center">
                                    <img src="{{ asset('theme/app-assets/images/illustration/email.svg') }}" alt="Meeting Pic" height="170" />
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="avatar-group">
                                        <div data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom" data-original-title="Billy Hopkins" class="avatar pull-up">
                                            <img src="{{ asset('theme/app-assets/images/portrait/small/avatar-s-9.jpg') }}" alt="Avatar" width="33" height="33" />
                                        </div>
                                        <div data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom" data-original-title="Amy Carson" class="avatar pull-up">
                                            <img src="{{ asset('theme/app-assets/images/portrait/small/avatar-s-6.jpg') }}" alt="Avatar" width="33" height="33" />
                                        </div>
                                        <div data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom" data-original-title="Brandon Miles" class="avatar pull-up">
                                            <img src="{{ asset('theme/app-assets/images/portrait/small/avatar-s-8.jpg') }}" alt="Avatar" width="33" height="33" />
                                        </div>
                                        <div data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom" data-original-title="Daisy Weber" class="avatar pull-up">
                                            <img src="{{ asset('theme/app-assets/images/portrait/small/avatar-s-20.jpg') }}" alt="Avatar" width="33" height="33" />
                                        </div>
                            ...
                            <div class="card card-browser-states">
                                ...
                                <div class="card-body">
                                    <div class="browser-states">
                                        <div class="media">
                                            <img src="{{ asset('theme/app-assets/images/icons/google-chrome.png') }}" class="rounded mr-1" height="30" alt="Google Chrome" />
                                    ...
                                    <div class="browser-states">
                                        <div class="media">
                                            <img src="{{ asset('theme/app-assets/images/icons/mozila-firefox.png') }}" class="rounded mr-1" height="30" alt="Mozila Firefox" />
                                    ...
                                    <div class="browser-states">
                                        <div class="media">
                                            <img src="{{ asset('theme/app-assets/images/icons/apple-safari.png') }}" class="rounded mr-1" height="30" alt="Apple Safari" />
                                    ...
                                    <div class="browser-states">
                                        <div class="media">
                                            <img src="{{ asset('theme/app-assets/images/icons/internet-explorer.png') }}" class="rounded mr-1" height="30" alt="Internet Explorer" />
                                    ...
                                    <div class="browser-states">
                                        <div class="media">
                                            <img src="{{ asset('theme/app-assets/images/icons/opera.png') }}" class="rounded mr-1" height="30" alt="Opera Mini" />
