...
<head>
    ...
    <title>GoTick - Member Registration</title>
...
<body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="blank-page">
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <a href="javascript:void(0);" class="brand-logo">
                                    ...
                                    <h2 class="brand-text text-primary ml-1">Go-Ticket</h2>
                                </a>

                                <h4 class="card-title mb-1">Adventure starts here 🚀</h4>
                                <p class="card-text mb-2">Lengkapi data berikut untuk melakukan registrasi member!</p>

                                <form class="auth-register-form mt-2" action="{{ route('register') }}" method="POST">
                                    @csrf
                                    <div class="form-group">
                                        <label for="register-name" class="form-label">Nama Lengkap</label>
                                        <input type="text" class="form-control" id="register-name" name="name" required placeholder="johndoe" aria-describedby="register-name" tabindex="1" autofocus />
                                    </div>

                                    <div class="form-group">
                                        <label for="register-email" class="form-label">Email</label>
                                        <input type="email" class="form-control" id="register-email" name="email" required placeholder="john@example.com" aria-describedby="register-email" tabindex="2" />
                                    </div>

                                    <div class="form-group">
                                        <label for="register-phone" class="form-label">No Telp. / Whatsapp</label>
                                        <input type="text" class="form-control" id="register-phone" name="phone" required placeholder="Contoh : 081XXXXXXXXX" aria-describedby="register-phone" tabindex="2" />
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-merge form-password-toggle">
                                            <input type="password" class="form-control form-control-merge" required id="register-password" name="password" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="register-password" tabindex="3" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-merge form-password-toggle">
                                            <input type="password" class="form-control form-control-merge" required id="password_confirmation" name="password_confirmation" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="register-password" tabindex="3" />
                                            <div class="input-group-append">
                                                <span class="input-group-text cursor-pointer"><i data-feather="eye"></i></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label class="custom-control-label" for="register-privacy-policy">
                                                Saya setuju dengan <a href="javascript:void(0);">ketentuan dan sayarat pengguna.</a>
                                            </label>
                                        </div>
                                    </div>
    ...
    <script src="{{ asset('theme/app-assets/js/scripts/pages/page-auth-register.js') }}"></script>
    <script>
